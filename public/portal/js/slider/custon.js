/**
 * Created by Ramos on 29/07/2015.
 */
    ...
    jQuery(document).ready(function ($) {
        ...
        function fnIsAppleMobile()
        {
            if (navigator && navigator.userAgent && navigator.userAgent != null)
            {
                ...
                var arrMatches = strUserAgent.match(/(android|webos|iphone|ipad|ipod|blackberry|iemobile|opera mini)/);
                if (arrMatches != null)
                {
                    _SlideshowTransitions = [
                        //{$Duration:1,$Opacity:1.8}
                    ];
                }else{

                    _SlideshowTransitions = [
                        {$Duration:2400,$Opacity:2,$Brother:{$Duration:3000,$Opacity:2}}
                    ];
        ...
        _CaptionTransitions["L"] = { $Duration: 1200, x: 0.6,$Easing:{$Left:$JssorEasing$.$EaseInOutSine}, $Opacity: 2 };
        _CaptionTransitions["R"] = { $Duration: 900, x: -0.6, $Easing: { $Left: $JssorEasing$.$EaseInOutSine }, $Opacity: 2 };
        _CaptionTransitions["T"] = { $Duration: 900, y: 0.6, $Easing: { $Top: $JssorEasing$.$EaseInOutSine }, $Opacity: 2 };
        _CaptionTransitions["B"] = { $Duration: 900, y: -0.6, $Easing: { $Top: $JssorEasing$.$EaseInOutSine }, $Opacity: 2 };
        _CaptionTransitions["TR"] = { $Duration: 900, x: -0.6, y: 0.6, $Easing: { $Left: $JssorEasing$.$EaseInOutSine, $Top: $JssorEasing$.$EaseInOutSine }, $Opacity: 2 };

        _CaptionTransitions["L|IB"] = { $Duration: 2000, x: 0.6, $Easing: { $Left: $JssorEasing$.$EaseInOutBack }, $Opacity: 2 };
        _CaptionTransitions["R|IB"] = { $Duration: 2000, x: -0.6, $Easing: { $Left: $JssorEasing$.$EaseInOutBack }, $Opacity: 2 };
        ...
        function ScaleSlider() {
            ...
            if (parentWidth){
                jssor_slider1.$ScaleWidth(Math.max(Math.min(parentWidth, 1140), 280));
                //console.log(Math.max(Math.min(parentWidth, 1140), 280));
            } else{
