    ...
    <tr>
        <td align="center" valign="middle" bgcolor="#ffffff" style="background:#ffffff">
            <table width="600" height="624" border="0" align="center" cellpadding="0" cellspacing="0" id="Table_01">
                ...
                <tr>
                    <td align="center" bgcolor="#dcdcdc"><img src="{{asset('assets/img/email/logo_azul.gif')}}"
                                                              width="216" height="159" alt=""></td>
                </tr>
                <tr>
                    <td valign="top" bgcolor="#F0F0F0" style="padding:0 50px;">
                        <h1>O iSonhei está de cara nova</h1>

                        <p class="texto">Prezado(a) <strong>{{$user->first_name}}</strong>, para acessar sua conta será
                            necessário recadastrar sua senha no Portal <strong>iSonhei</strong>.</p>
