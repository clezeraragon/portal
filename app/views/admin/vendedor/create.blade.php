                    ...
                    <div class="portlet-body">
                        ...
                        <fieldset>
                            ...
                            <div class="form-group {{ $errors->first('user_id', 'has-error') }}">
                                ...
                                <div class="col-md-7">
                                    {{ Form::select('user_id', User::comboboxUser(), null, array('class' => 'form-control select2', 'required','id'=>'e1')) }}
                            ...
                            <div class="form-group {{ $errors->first('nome', 'has-error') }}">
                                ...
                                <div class="col-md-7">
                                    {{ Form::text('nome', Input::old('nome'), array('placeholder' => 'Nome do Vendedor', 'class' => 'form-control input-md', 'required')) }}
