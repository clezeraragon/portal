                ...
                <div class="portlet-body">
                     {{ Form::open(array('url' => $data['route'], 'class' => 'form-horizontal', 'files' => true)) }}
                        ...
                        <div class="form-group {{ $errors->first('cliente_id', 'has-error') }} ">
                            ...
                            <div class="col-md-7">
                                {{ Form::select('cliente_id', Cliente::combobox(), Input::old('cliente_id'), array('class' => 'form-control select2','id'=>'clientes', 'required')) }}
                        ...
                        <div class="form-group {{ $errors->first('guia_empresa_id', 'has-error') }} ">
                            ...
                            <div class="col-md-7">
                                {{ Form::select('guia_empresa_id', array('' => 'Selecione uma opção'), Input::old('guia_empresa_id'), array('class' => 'form-control','id'=>'anuncios')) }}
                        ...
                        <div class="form-group {{ $errors->first('titulo', 'has-error') }}">
                          ...
                          <div class="col-md-7">
                             {{ Form::text('titulo', Input::old('titulo'), array('placeholder' => 'Título do cupom', 'class' => 'form-control input-md', 'required')) }}
                        ...
                        <div class="form-group {{ $errors->first('voucher', 'has-error') }}">
                          ...
                          <div class="col-md-7">
                             {{ Form::text('voucher', Input::old('voucher'), array('placeholder' => 'Voucher de desconto', 'class' => 'form-control input-md', 'required')) }}
                        ...
                        <div class="form-group {{ $errors->first('descricao', 'has-error') }}">
                            ...
                            <div class="col-md-7">
                                {{ Form::textarea('descricao', Input::old('descricao'), array('placeholder' => 'Descrição do produto/serviço', 'class' => 'form-control', 'required', 'size' => '30x2')) }}
                        ...
                        <div class="form-group {{ $errors->first('regras', 'has-error') }}">
                            ...
                            <div class="col-md-7">
                                {{ Form::textarea('regras', Input::old('regras'), array('placeholder' => 'Regras de uso do voucher', 'class' => 'form-control', 'required', 'size' => '30x2')) }}
                        ...
                        <div class="form-group {{ $errors->first('quantidade', 'has-error') }}">
                            ...
                            <div class="col-md-7">
                                {{ Form::text('quantidade', Input::old('quantidade'), array('placeholder' => 'Quantos usuários podem solicitar este voucher?', 'class' => 'form-control input-md', 'required')) }}
                        ...
                        <div class="form-group {{ $errors->first('dt_ini', 'has-error') }}">
                          ...
                          <div class="col-md-7">
                             {{ Form::text('dt_ini', Input::old('dt_ini'), array('placeholder' => '', 'class' => 'form-control input-md', 'required')) }}
                        ...
                        <div class="form-group {{ $errors->first('dt_fim', 'has-error') }}">
                          ...
                          <div class="col-md-7">
                             {{ Form::text('dt_fim', Input::old('dt_fim'), array('placeholder' => '', 'class' => 'form-control input-md', 'required')) }}
...
@section('footer_scripts')
    ...
    <script>
        ...
        $('#clientes').change(function () {
            ...
            $.get('get-anuncio-cliente/' + param, function (anuncios) {
