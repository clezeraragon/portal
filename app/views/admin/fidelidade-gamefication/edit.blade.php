	                ...
	                {{ Form::open(array('url' => $data['route'] . '/' . $rs->id, 'method' => 'put', 'class' => 'form-horizontal', 'files' => true)) }}
                        <fieldset>
                            ...
                            <div class="form-group {{ $errors->first('fator', 'has-error') }}">
                                ...
                                <div class="col-md-7">
                                    {{ Form::text('fator', Input::old('fator', $rs->fator), array('placeholder' => 'Utilize ponto na casa decimal Ex: 1.5', 'class' => 'form-control input-md', 'required')) }}
                            ...
                            <div class="form-group {{ $errors->first('pontos', 'has-error') }}">
                                ...
                                <div class="col-md-7">
                                    {{ Form::text('pontos', Input::old('pontos', $rs->pontos), array('placeholder' => 'Pontos', 'class' => 'form-control input-md', 'required')) }}
                            ...
                            <div class="form-group {{ $errors->first('nivel', 'has-error') }}">
                                ...
                                <div class="col-md-7">
                                    {{ Form::text('nivel', Input::old('nivel', $rs->nivel), array('placeholder' => 'Nível', 'class' => 'form-control input-md', 'required')) }}
