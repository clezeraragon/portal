            ...
            <div class="col-md-12">
                ...
                <div class="portlet box primary">
                    ...
                    <div class="portlet-body">
                        {{ Form::open(array('url' => $data['route'] . '/' . $rs->id, 'method' => 'put', 'class' => 'form-horizontal')) }}
                        <fieldset>
                            ...
                            <div class="form-group {{ $errors->first('responsavel_id', 'has-error') }}">
                                ...
                                <div class="col-md-7">
                                    {{ Form::select('responsavel_id', User::comboboxUser(), Input::old('responsavel_id',$rs->responsavel_id), array('class' => 'form-control select2','id'=>'e2')) }}
                            ...
                            <div class="form-group {{ $errors->first('cliente_id', 'has-error') }}">
                                ...
                                <div class="col-md-7">
                                    {{ Form::select('cliente_id', Cliente::combobox(), Input::old('cliente_id',$rs->cliente_id), array('class' => 'form-control select2','id'=>'e3')) }}
                            ...
                            <div class="form-group {{ $errors->first('observacao', 'has-error') }}">
                                ...
                                <div class="col-md-7">
                                    {{ Form::textarea('observacao', Input::old('observacao',$rs->observacao), array('placeholder' => 'Observaçao', 'class' => 'form-control', 'size' => '30x2', 'maxlength' => '160')) }}
                            ...
                            <div class="form-group {{ $errors->first('status', 'has-error') }} ">
                                ...
                                <div class="col-md-7">
                                    <label class="radio-inline" for="radios-0">
                                        <input type="radio" name="status" value="1" @if($rs->status == "1")
                                               checked="checked" @endif>
                                        Ativo
                                    </label>
                                    <label class="radio-inline" for="radios-1">
                                        <input type="radio" name="status" value="0" @if($rs->status == "0")
                                               checked="checked" @endif>
                                        Inativo
                                    </label>
