                        ...
                        <tbody>
                            @foreach ($conteudos as $conteudo)
                                <tr>
                                    ...
                                    <td>
                                        {{ link_to('/admin/conteudo/' . $conteudo->url . '/preview', 'Visualizar', array('class' => 'btn btn-info btn-sm', 'target'=>'_blank', 'title' => 'Visualizar')) }}</td>

                                    </td>
                                    <td>
                                        {{ link_to($data['route'] . '/' . $conteudo->id . '/edit', 'Editar', array('class' => 'btn btn-warning btn-sm', 'title' => 'Editar')) }}</td>
                                    </td>
                                    <td>
