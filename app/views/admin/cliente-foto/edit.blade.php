	                ...
	                {{ Form::open(array('url' => $data['route'] . '/' . $rs->id, 'method' => 'put', 'class' => 'form-horizontal', 'files' => true)) }}
                        <fieldset>
                                ...
                                <div class="form-group {{ $errors->first('cliente_id', 'has-error') }}">
                                  ...
                                  <div class="col-md-7">
                                    {{ Form::select('cliente_id', Cliente::combobox(), Input::old('cliente_id', $rs->cliente_id), array('class' => 'form-control select2','id' => 'e1', 'required')) }}
                                    {{--{{ Form::hidden('cliente_id', Input::old('cliente_id', $rs->cliente_id)) }}--}}
                                ...
                                <div class="form-group {{ $errors->first('titulo', 'has-error') }}">
                                  ...
                                  <div class="col-md-7">
                                     {{ Form::text('titulo', Input::old('titulo', $rs->titulo), array('placeholder' => 'Título da foto', 'class' => 'form-control input-md', 'required')) }}
                                ...
                                <div class="form-group {{ $errors->first('ordem', 'has-error') }}">
                                  ...
                                  <div class="col-md-7">
                                     {{ Form::text('ordem', Input::old('ordem', $rs->ordem), array('placeholder' => 'Ordem da foto no Guia', 'class' => 'form-control input-md', 'required')) }}
