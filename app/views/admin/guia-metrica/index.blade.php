                    ...
                    <div class="portlet-body">
                        ...
                        <table class="table table-striped table-bordered table-hover" id="sample_1">
                            ...
                            <tr>
                                ...
                                <th>Click Site</th>
                                <th>Msg. Enviada</th>
                                <th>Click Facebook </th>
                                <th>Click Instagram</th>
                                <th>Click Twitter</th>
                                <th>Click Foto</th>
                                <th>Click Vídeo</th>
                                <th>Compartilhar Pag.</th>
                                <th>Período</th>
                            </tr>
                            </thead>
                            <tbody>
                            ...
                            @foreach ($result as $key => $value)
                                ...
                                <tr>
                                    <td>{{ ($value['empresa']) }}</td>
                                    <td>@if(isset($value[10])){{ ($value[10]) }} @else 0 @endif</td>
                                    <td>@if(isset($value[1])) {{ ($value[1])  }} @else 0 @endif</td>
                                    <td>@if(isset($value[2])) {{ ($value[2])  }} @else 0 @endif</td>
                                    <td>@if(isset($value[3])) {{ ($value[3])  }} @else 0 @endif</td>
                                    <td>@if(isset($value[4])) {{ ($value[4])  }} @else 0 @endif</td>
                                    <td>@if(isset($value[5])) {{ ($value[5])  }} @else 0 @endif</td>
                                    <td>@if(isset($value[13])){{ ($value[13]) }} @else 0 @endif</td>
                                    <td>@if(isset($value[14])){{ ($value[14]) }} @else 0 @endif</td>
                                    <td>@if(isset($value[15])){{ ($value[15]) }} @else 0 @endif</td>
                                    <td>@if(isset($value[16])){{ ($value[16]) }} @else 0 @endif</td>
                                    <td>@if(isset($value[9])) {{ ($value[9])  }} @else 0 @endif</td>
                                    <td>@if(isset($value[8])) {{ ($value[8])  }} @else 0 @endif</td>
                                    <td>{{ ($periodo)  }}</td>
