                ...
                <div class="portlet-body">
                     {{ Form::open(array('url' => $data['route'], 'class' => 'form-horizontal', 'files' => true)) }}
                        ...
                        <div class="form-group {{ $errors->first('acao_id', 'has-error') }} ">
                            ...
                            <div class="col-md-7">
                                {{ Form::select('acao_id', FidelidadeAcao::combobox(), Input::old('acao_id'), array('class' => 'form-control')) }}
                        ...
                        <div class="form-group {{ $errors->first('codigo', 'has-error') }}">
                          ...
                          <div class="col-md-7">
                             {{ Form::text('codigo', Input::old('codigo'), array('placeholder' => 'Limite de 45 caracteres', 'class' => 'form-control input-md', 'required')) }}
                        ...
                        <div class="form-group {{ $errors->first('dsc_codigo', 'has-error') }}">
                          ...
                          <div class="col-md-7">
                             {{ Form::text('dsc_codigo', Input::old('dsc_codigo'), array('placeholder' => 'Descrição do código', 'class' => 'form-control input-md', 'required')) }}
                        ...
                        <div class="form-group {{ $errors->first('quantidade', 'has-error') }}">
                          ...
                          <div class="col-md-7">
                             {{ Form::text('quantidade', Input::old('quantidade'), array('placeholder' => 'Quantas vezes este código poderá ser utilizado?', 'class' => 'form-control input-md', 'required')) }}
