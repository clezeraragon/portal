                ...
                <div class="portlet-body">
                       {{ Form::open(array('url' => $data['route'], 'class' => 'form-horizontal')) }}
                           ...
                           <div class="form-group {{ $errors->first('perfil', 'has-error') }}">
                             ...
                             <div class="col-md-7">
                                {{ Form::text('perfil', Input::old('perfil'), array('placeholder' => 'Perfil', 'class' => 'form-control input-md', 'required')) }}
                            ...
                            <div class="form-group {{ $errors->first('st_admin', 'has-error') }}">
                              ...
                              <div class="col-md-7">
                                <label class="radio-inline" for="radios-0">
                                  <input type="radio" name="st_admin" id="st_admin-0" value="1">
                                  Sim
                                </label>
                                <label class="radio-inline" for="radios-1">
                                  <input type="radio" name="st_admin" id="st_admin-1" value="0">
                                  Não
                                </label>
                                {{ $errors->first('st_admin', '<span class="text-danger">:message</span>') }}
                              </div>
                            </div>
                            ...
                            <div class="form-group {{ $errors->first('funcionalidades_ids', 'has-error') }}">
                                ...
                                <div class="col-md-7">
                                    ...
                                    @foreach (Funcionalidade::options() as $funcionalidade)
                                        ...
                                        <div class="checkbox col-md-12">
                                            {{ Form::checkbox('funcionalidades_ids[]', $funcionalidade->id, null, array('id' => $funcionalidade->id)) . ' ' . Form::label($funcionalidade->id, $funcionalidade->funcionalidade)}}
                                        </div>
