	                ...
	                {{ Form::open(array('url' => $data['route'] . '/' . $rs->id, 'method' => 'put', 'class' => 'form-horizontal', 'files' => true)) }}
                        <fieldset>
                            ...
                            <div class="form-group {{ $errors->first('cliente_id', 'has-error') }}">
                              ...
                              <div class="col-md-7">
                                {{ Form::select('cliente_id', Cliente::comboboxAll($rs->cliente_id), Input::old('cliente_id', $rs->cliente_id), array('class' => 'form-control select2','id'=>'e1', 'required')) }}
                            ...
                            <div class="form-group {{ $errors->first('cidade_id', 'has-error') }}">
                              ...
                              <div class="col-md-7">
                                {{ Form::select('cidade_id', GuiaCidade::combobox(), Input::old('cidade_id', $rs->cidade_id), array('class' => 'form-control select2','id'=>'e2', 'required')) }}
                            ...
                            <div class="form-group {{ $errors->first('categoria_id', 'has-error') }}">
                              ...
                              <div class="col-md-7">
                                {{ Form::select('categoria_id', GuiaCategoria::combobox(), Input::old('categoria_id', $rs->categoria_id), array('class' => 'form-control select2','id'=>'e3', 'required')) }}
                            ...
                            <div class="form-group {{ $errors->first('plano_id', 'has-error') }}">
                              ...
                              <div class="col-md-7">
                                {{ Form::select('plano_id', GuiaPlano::combobox(), Input::old('plano_id', $rs->plano_id), array('class' => 'form-control', 'required')) }}
                                {{ $errors->first('plano_id', '<span class="text-danger">:message</span>') }}
                                {{--{{ Form::hidden('plano_id', Input::old('plano_id', $rs->plano_id), array()) }}--}}
                              </div>
                            </div>
                            ...
                            <div class="form-group {{ $errors->first('url', 'has-error') }}">
                                ...
                                <div class="col-md-7">
                                    {{ Form::text('url', Input::old('url', $rs->url), array('placeholder' => 'url-seguindo-o-padrao', 'class' => 'form-control input-md', 'required', 'id' => 'url')) }}
                            ...
                            <div class="form-group {{ $errors->first('qtd_imagem', 'has-error') }}">
                              ...
                              <div class="col-md-7">
                                 {{ Form::text('qtd_imagem', Input::old('qtd_imagem', $rs->qtd_imagem), array('placeholder' => 'Quantidade de imagens', 'class' => 'form-control input-md', 'required')) }}
                            ...
                            <div class="form-group {{ $errors->first('qtd_video', 'has-error') }}">
                              ...
                              <div class="col-md-7">
                                 {{ Form::text('qtd_video', Input::old('qtd_video', $rs->qtd_video), array('placeholder' => 'Quantidade de Vídeos', 'class' => 'form-control input-md', 'required')) }}
                            ...
                            <div class="form-group {{ $errors->first('dt_ini', 'has-error') }}">
                              ...
                              <div class="col-md-7">
                                 {{ Form::text('dt_ini', Input::old('dt_ini', Util::toView($rs->dt_ini)), array('placeholder' => 'dd/mm/yyyy', 'class' => 'form-control input-md', 'required')) }}
                            ...
                            <div class="form-group {{ $errors->first('dt_fim', 'has-error') }}">
                              ...
                              <div class="col-md-7">
                                 {{ Form::text('dt_fim', Input::old('dt_fim', Util::toView($rs->dt_fim)), array('placeholder' => 'dd/mm/yyyy', 'class' => 'form-control input-md', 'required')) }}
                           ...
                           <div class="form-group {{ $errors->first('descricao', 'has-error') }}">
                             ...
                             <div class="col-md-7">
                                 {{ Form::textarea('descricao', Input::old('descricao', $rs->descricao), array('placeholder' => 'Resumo da Empresa na página de filtro', 'class' => 'form-control', 'required', 'size' => '30x2', 'maxlength' => '160')) }}
                            ...
                            <div class="form-group {{ $errors->first('texto', 'has-error') }}">
                              ...
                              <div class="col-md-7">
                                  {{ Form::textarea('texto', Input::old('texto', $rs->texto), array('placeholder' => 'Texto sobre a empresa', 'class' => 'form-control', 'required', 'size' => '30x4', 'id' => 'ckeditor_full')) }}
                            ...
                            <div class="form-group {{ $errors->first('observacoes', 'has-error') }}">
                                ...
                                <div class="col-md-7">
                                    {{ Form::textarea('observacoes', Input::old('observacoes', $rs->observacoes), array('placeholder' => 'Opcionais e Observações', 'class' => 'form-control', 'size' => '30x2', 'maxlength' => '160')) }}
                            ...
                            <div class="form-group {{ $errors->first('email_responsavel_anuncio', 'has-error') }}">
                                ...
                                <div class="col-md-7">
                                    {{ Form::text('email_responsavel_anuncio', Input::old('email_responsavel_anuncio', $rs->email_responsavel_anuncio), array('placeholder' => 'Ao preencher este campo as mensagens do anúncio serão enviadas para este e-mail.', 'class' => 'form-control input-md')) }}
                            ...
                            <div class="form-group {{ $errors->first('tipo_negociacao', 'has-error') }} ">
                                ...
                                <div class="col-md-7">
                                    <label class="radio-inline" for="radios-0">
                                        <input type="radio" name="tipo_negociacao" value="Contrato" @if($rs->tipo_negociacao == "Contrato") checked="checked" @endif>
                                        Contrato
                                    </label>
                                    <label class="radio-inline" for="radios-1">
                                        <input type="radio" name="tipo_negociacao" value="Bonificado" @if($rs->tipo_negociacao == "Bonificado") checked="checked" @endif>
                                        Bonificado
                                    </label>
