            ...
            <div class="row">
                ...
                <div class="col-sm-16">
                    <div class="row">
                        ...
                        {{ Form::open(array('url' => 'site-sonhador/construtor/fotos/' . $siteid, 'method' => 'post', 'class' => 'form-horizontal', 'files' => true)) }}
                            <fieldset>
                                ...
                                <div class="form-group {{ $errors->first('titulo', 'has-error') }}">
                                    ...
                                    <div class="col-md-9">
                                        {{ Form::text('titulo', Input::old('titulo'), array('id' => 'titulo', 'placeholder' => 'Título da foto','class' => 'form-control input-md', 'required','maxlength' => '80')) }}
